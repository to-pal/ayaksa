...
<ul class="nav nav-tabs">
	<li id="basic_tab" class="active"><a href="#basic-settings" data-toggle="tab"><?php echo JText::_('BASIC_SETTINGS'); ?></a></li>
	<li id="advanced_tab"><a href="#advanced-settings" data-toggle="tab"><?php echo JText::_('ADVANCED_SETTINGS'); ?></a></li>
	<li id="file-browser_tab"><a href="#file-browser-settings" data-toggle="tab"><?php echo JText::_('FILE_BROWSER_SETTINGS'); ?></a></li>
	<li id="layout_tab"><a href="#layout-settings" data-toggle="tab"><?php echo JText::_('LAYOUT_SETTINGS'); ?></a></li>
	<li id="license_information_tab"><a href="#license-information-settings" data-toggle="tab"><?php echo JText::_('LICENSE_INFORMATION'); ?></a></li>

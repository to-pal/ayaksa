<?php
/*
* @copyright Copyright (c) 2003-2013, CKSource - Frederico Knabben. All rights reserved.
* @license	 GNU/GPL
...
//					$licenseName = $this->params->get( 'PackageLicenseName','');
					...
					$licenseName = $_SERVER['HTTP_HOST'];
					$licenseKey = 'CP0K0132U12X2K0CP0K000000G0000U00X2000000000000G0';
					$license = checkPackageLicense($licenseKey, $licenseName);
					$session->set('LicenseName',$_SERVER['HTTP_HOST']);

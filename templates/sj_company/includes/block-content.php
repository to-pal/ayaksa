...
if ($position['group'] == '') { // Position none group
	...
	if($position['group'] == 'left') {
		...
		if($countL == 1) {
			...
			echo '<div class="content-left-in row-fluid">';			
		...
		if ($countM == 1) {
			...
			echo '<div class="content-main-inner row-fluid">';			
			echo $yt->renPositionsGroup($position, 'main', $tagBD);
		...
		if($countR == 1) {		       
			...
			echo '<div class="content-right-in row-fluid">';
			echo $yt->renPositionsGroup($position, 'block-content');

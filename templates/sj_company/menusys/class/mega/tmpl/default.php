...
if ( $this->isRoot() ){
	...
	$document->addStyleSheet($yt->templateurl().'menusys/class/common/css/menustyle.css','text/css');
	$document->addStyleSheet($yt->templateurl().'menusys/class/common/css/jshover.css','text/css');
	$document->addStyleSheet($yt->templateurl().'menusys/class/common/css/megamenu-components.css','text/css');
	$document->addStyleSheet($yt->templateurl().'menusys/class/mega/assets/megamenu.css','text/css');
	...
	<script type="text/javascript">
		jQuery(function($){
            $('#meganavigator').megamenu({ 
				...
				'justify': '<?php echo ($this->params->get("direction")=="ltr")?"left":"right" ?>'
            });
	    });
	</script>
	<?php

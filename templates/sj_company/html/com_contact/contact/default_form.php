	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate">
		<fieldset>
			...
			<dl>
                ...
                <dt><?php echo $this->form->getLabel('contact_date'); ?></dt>
				<dd><?php echo $this->form->getInput('contact_date'); ?></dd>
				...
				<?php 	if ($this->params->get('show_email_copy')){ ?>
						<dt></dt>
						<dd><?php echo $this->form->getLabel('contact_email_copy'); ?><?php echo $this->form->getInput('contact_email_copy'); ?></dd>
				<?php 	} ?>
